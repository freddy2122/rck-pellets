...
<head>
    ...
    <meta name="description" content="{{ $meta['description'] ?? 'Tienda online de pellets Steampower y leña de calefacción en España. IVA incluido, factura con NIF/NIE y entrega en la Península a 1,50 €.' }}">
